...
const DeepZoomViewer = () => {
  ...
  useEffect(() => {
    ...
    const viewer1 = OpenSeadragon({
      id: "osd-viewer-1",
      prefixUrl: "https://openseadragon.github.io/openseadragon/images/",
      tileSources: "http://localhost:3000/tiles/1760370829140-img_1758257779888_151m2d8em.tiff/1760370829140-img_1758257779888_151m2d8em.tiff.dzi", // 🔁 Change if needed
      showNavigator: true,
      visibilityRatio: 1,
    });
